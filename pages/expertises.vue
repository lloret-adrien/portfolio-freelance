      ...
      <div class="max-w-4xl lg:max-w-5xl mx-auto px-4 sm:px-6">
        <div class="relative pt-[100vh] pb-[40vh] flex flex-col items-center">
          <div
            ...
            :class="[
              'sticky top-[calc(50vh-175px)] md:top-[calc(50vh-210px)] w-full h-[350px] md:h-[420px] rounded-[2.5rem] md:rounded-[3.5rem] p-8 md:p-14 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.25)] border border-black/5 transition-transform duration-150 ease-out hover:scale-[1.01] group overflow-hidden mb-[60vh]',
